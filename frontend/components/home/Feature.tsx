...
const Feature = () => {
    return (
        ...
        <div className='flex flex-col lg:flex-row justify-center items-center text-center lg:text-left  gap-4 col-start-1 md:col-start-auto col-end-3 md:col-end-auto py-2 md:py-6 border-solid'>
            <div className='p-3 rounded-full bg-green-50'>
                <svg  height={"38px"} fill="#00B207" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
