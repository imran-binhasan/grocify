...
import Reviewers from '../../components/shared/Reviewers';
import Pagination from '../../components/shared/Pagination ';
import face1 from "../../public/face/face-1.jpg"
import face2 from "../../public/face/face-2.avif"
import face3 from "../../public/face/face-3.avif"
import face4 from "../../public/face/face-4.avif"
            ...
            <div className=''>
                ...
                <div className='text-gray-600 font-normal text-sm text-justify'>
                    ...
                    <ul className='text-left space-y-2 mb-4'>
                        <li><span className='bg-green-500 px-1 rounded-full text-white mr-1'><CheckIcon/></span>100 g of fresh leaves provides.</li>
                        <li><span className='bg-green-500 px-1 rounded-full text-white mr-1'><CheckIcon/>/</span>Aliquam ac est at augue volutpat elementum.</li>
                        <li><span className='bg-green-500 px-1 rounded-full text-white mr-1'><CheckIcon/>/</span>Quisque nec enim eget sapien molestie.</li>
                        <li><span className='bg-green-500 px-1 rounded-full text-white mr-1'><CheckIcon/>/</span>Proin convallis odio volutpat finibus posuere.</li>
                    </ul>
